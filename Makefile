...
help:
	...
	@echo "  make check-rules FOLDER=governance/indexes/security/   Check which rules are stale"
...
extract-rules:
	...
	@echo "    @rules-extraction-agent Extract rules from path/to/any/folder/"
	@echo ""
	@echo "  Single file mode:"
	@echo "    @rules-extraction-agent Extract rules from governance/indexes/security/123-auth.md for category security"
	@echo ""
	@echo "  Output:"
	@echo "    Per-file:      <name>.rules.md   (one per source .md)"
